...
use Drupal\customers\Entity\CustomerEntity;
 ...
 *
 */
class CustomerEntityPermissions{
   ...
   *
   * @return array
   *   The CustomerEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (CustomerEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\customers\Entity\CustomerEntity $type
   *   The CustomerEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(CustomerEntity $type) {
    $type_id = $type->id();
