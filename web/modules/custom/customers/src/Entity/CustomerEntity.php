 ...
 *   bundle_label = @Translation("Customers type"),
 *   handlers = {
 *     "storage" = "Drupal\customers\CustomerEntityStorage",
 ...
 *     "translation" = "Drupal\customers\CustomerEntityTranslationHandler",
 *
 *     "form" = {
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/customer_entity/{customer_entity}",
 *     "add-page" = "/admin/structure/customer_entity/add",
 *     "add-form" = "/admin/structure/customer_entity/add/{customer_entity_type}",
 *     "edit-form" = "/admin/structure/customer_entity/{customer_entity}/edit",
 *     "delete-form" = "/admin/structure/customer_entity/{customer_entity}/delete",
 *     "version-history" = "/admin/structure/customer_entity/{customer_entity}/revisions",
 *     "revision" = "/admin/structure/customer_entity/{customer_entity}/revisions/{customer_entity_revision}/view",
 *     "revision_revert" = "/admin/structure/customer_entity/{customer_entity}/revisions/{customer_entity_revision}/revert",
 *     "revision_delete" = "/admin/structure/customer_entity/{customer_entity}/revisions/{customer_entity_revision}/delete",
 *     "translation_revert" = "/admin/structure/customer_entity/{customer_entity}/revisions/{customer_entity_revision}/revert/{langcode}",
 *     "collection" = "/admin/structure/customer_entity",
 *   },
 *   bundle_entity_type = "customer_entity_type",
 *   field_ui_base_route = "entity.customer_entity_type.edit_form"
 * )
 */
class CustomerEntity extends EditorialContentEntityBase implements CustomerEntityInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // make the customer_entity owner the revision author.
